...
logger = logging.getLogger('ingest_folder_1')

FOLDER_PATH = Path("/Users/OTI_1/Desktop/pojehat/pdfs/1")
...
async def main():
    ...
    for i, pdf_path in enumerate(pdf_files, 1):
        ...
        try:
            ...
            context = f"Local Document Ingestion - Folder 1: {pdf_path.stem.replace('_', ' ')}"
    ...
    logger.info(f"=== Ingestion Folder 1 complete: {ok} ok / {fail} failed ===")
